"""
Test if the generated Profile format meets the OASIS requirements.
Validation:
1. Twitter Profile generates in CSV format.
2. Reddit Profile generates in detailed JSON format.
"""
