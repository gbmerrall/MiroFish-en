...
class ZepEntityReader:
    ...
    def _call_with_retry(
        ...
        Args:
            ...
            max_retries: Maximum number of retries (default 3, i.e., max 3 attempts)
    ...
    def filter_defined_entities(
        ...
        Filtering logic:
        - If a node's Labels only contain "Entity", it means this entity does not match our predefined types, so skip it.
        - If a node's Labels contain tags other than "Entity" and "Node", it means it matches a predefined type, so keep it.
        
        Args:
            graph_id: Graph ID
            defined_entity_types: List of predefined entity types (optional, if provided, only these types will be kept)
        ...
        for node in all_nodes:
            ...
            if enrich_with_edges:
                ...
                # Get basic information of connected nodes
                related_nodes = []
    ...
    def get_entity_with_context(
        ...
        """
        Get a single entity and its complete context (edges and connected nodes, with retry mechanism)
