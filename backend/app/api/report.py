...
def generate_report():
    ...
    try:
        ...
        if not simulation_id:
            return jsonify(
                {"success": False, "error": "Please provide a simulation_id"}
            ), 400
...
def delete_report(report_id: str):
    ...
    try:
        ...
        return jsonify(
            {"success": True, "message": f"Report has been deleted: {report_id}"}
        )
...
def search_graph_tool():
    ...
    try:
        ...
        from ..services.graph_tools import GraphitiToolsService
