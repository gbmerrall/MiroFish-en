      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Graph construction will begin automatically upon completion</p>
          </div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading the documents, the LLM analyzes the content and automatically generates an ontology structure (entity types + relation types) suitable for public opinion simulation.
                </div>
              </div>
...
const startBuildGraph = async () => {
  try {
    ...
    if (response.success) {
      buildProgress.value.message = 'Graph construction task has been initiated...'
      
      // Save task_id for polling
      const taskId = response.data.task_id
      
      // Start polling for graph data (independent of task status polling)
      startGraphPolling()
  ...
  try {
    ...
    if (projectResponse.success && projectResponse.data.graph_id) {
      ...
      if (graphResponse.success && graphResponse.data) {
        ...
        // Update rendering if data has changed
