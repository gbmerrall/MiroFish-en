          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">Select a person to talk to</div>
                <div 
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A quick chat version of the report generation intelligent agent, which can call 4 professional tools and has the complete memory of MiroFish</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Align real-world seed data with the simulation environment state, and provide cross-temporal deep attribution analysis combined with the Global/Local Memory mechanism</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Reconstruct event propagation paths based on a graph-structured breadth-first traversal algorithm to capture the full topological structure of information flow</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">An instant query interface based on GraphRAG, optimizing index efficiency for fast extraction of specific node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">An autonomous interview that can conduct multiple rounds of dialogue with individuals in the simulated world in parallel to collect unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with the Report Agent to learn more about the report' : 'Chat with simulated individuals to understand their views' }}
              </p>
            </div>
            <div 
...
const selectReportAgentChat = () => {
  ...
  // Restore the chat history of the Report Agent
...
const selectAgent = (agent, idx) => {
  ...
  // Restore the chat history of this Agent
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Prioritize using reddit platform responses, then twitter
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      for (const interview of interviews) {
        ...
        // Prioritize using reddit platform response, then twitter
...
/* Quote style in chat/survey area */
