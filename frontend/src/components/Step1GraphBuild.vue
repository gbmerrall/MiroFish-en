    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            The LLM analyzes the document content and simulation requirements, extracts real-world seeds, and automatically generates a suitable ontology structure.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, the document is automatically chunked and Zep is called to build the knowledge graph, extract entities and relationships, and form temporal memory and community summaries.
          </p>
...
const handleEnterEnvSetup = async () => {
  ...
  try {
    ...
    alert('Exception while creating simulation: ' + err.message)
  } finally {
